...
<script type="text/javascript">
	...
	function selectOrg(){
		document.getElementById("act").value = "selectOrg";
	}	
</script>
...
<input name="act" id="act" type="hidden" value="create" >
<input name="pid" id="pid" type="hidden" value="0">
<input name="eventid" id="eventid" type="hidden" value="<?php echo $_GET['eventId']; ?>">
<legend> Select a person<legend>
	<br>
	<input type="submit" value="None" onclick="selectOrg();"><br>
